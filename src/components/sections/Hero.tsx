...
export const Hero: React.FC = () => {
  return (
    <section id="home" className="min-h-screen flex items-start bg-gradient-to-br from-white to-lightbg pt-32">
      <Container>
        {/* Desktop Layout - Original good layout */}
        <div className="hidden xl:grid xl:grid-cols-2 items-start top-10">
          {/* Right side - Text content */}
          <div className="order-2 space-y-6 left ml-[-28%]">
            {/* Greeting */}
            ...
            {/* Name and Title */}
            <h1 className="text-4xl md:text-5xl lg:text-[3.5rem] font-bold text-dark leading-tight whitespace-nowrap">
              {siteConfig.name}
            </h1>
          ...
          <div className="order-1 flex justify-left items-start mt-7 ml-[-5%]">
        ...
        <div className="xl:hidden flex flex-col items-center space-y-8 px-4">
          {/* Profile Image */}
          <div className="flex justify-center pt-8">
            <div className="relative">
              ...
              {/* Profile Image Container */}
              <div className="relative z-10 w-56 h-56 sm:w-64 sm:h-64 rounded-3xl overflow-hidden shadow-2xl border-4 border-white">
                <img
                  src={getAssetPath("/profile.jpg")}
                  alt={siteConfig.name}
                  className="w-full h-full object-cover"
              ...
              {/* Floating badge */}
              <div className="absolute -bottom-3 -right-3 bg-white rounded-2xl shadow-xl p-3 z-20">
                <div className="flex items-center gap-2">
          ...
          <div className="space-y-5 text-center w-full">
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2 px-4">
              <Button variant="primary" size="lg" href="#contact">
                Contact Me
              </Button>
              <Button variant="outline" size="lg" href={siteConfig.cvUrl}>
            ...
            <div className="pt-4">
              ...
              <div className="flex flex-wrap justify-center gap-2.5">
                <div className="flex items-center gap-2 px-3 py-2 bg-orange-600 text-white rounded-lg shadow-md">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z" />
                  </svg>
                  <span className="text-xs font-semibold">AWS Cloud Club Captain</span>
                </div>
                <div className="flex items-center gap-2 px-3 py-2 bg-blue-600 text-white rounded-lg shadow-md">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                  </svg>
                  <span className="text-xs font-semibold">Program Team Lead - IEEE SB UOJ</span>
                </div>
                <div className="flex items-center gap-2 px-3 py-2 bg-indigo-600 text-white rounded-lg shadow-md">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="text-xs font-semibold">QA Engineer - Enfera</span>
                </div>
                <div className="flex items-center gap-2 px-3 py-2 bg-green-600 text-white rounded-lg shadow-md">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                  </svg>
                  <span className="text-xs font-semibold">Volunteer Management Lead - STEMUP</span>
                </div>
                <div className="flex items-center gap-2 px-3 py-2 bg-purple-600 text-white rounded-lg shadow-md">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="text-xs font-semibold">Finance Team Member - IEEE INSL</span>
                </div>
              </div>
            </div>
          </div>
